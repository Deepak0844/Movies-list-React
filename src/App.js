...
},
{
  ...
  return (
    <div className="App">
      {moviesList.map(m=><Movies movTitle={m.title} poster={m.image} runningTime={m.runningtime} Genre={m.Genres}
       movRating={m.rating} releaseDate={m.releasedate} movSummary={m.summary}/>)}
      
    </div>
);}
function Movies({movTitle,poster,runningTime,Genre,movRating,releaseDate,movSummary}){
  return(
  <div className="movieDetails">
    <img className="poster" src={poster}alt={movTitle} />
      ...
      <div className="information">
        <p><span className="fa fa-star checked"></span> {movRating}</p>
         <p>{movSummary}</p>
